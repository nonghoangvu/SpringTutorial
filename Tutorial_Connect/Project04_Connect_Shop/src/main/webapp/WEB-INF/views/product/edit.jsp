...
<h1 class="text-center text-secondary text-uppercase m-3">Update Product</h1>
<div class="container-sm m-5 align-middle">
    <form:form modelAttribute="product" action="/product/update?id=${product.id}" method="post" enctype="multipart/form-data">
