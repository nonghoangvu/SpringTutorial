...
import {addStudent, getStudent, getStudents, updateStudent} from "../service/Student_API";
...
export const Student_Edit = () => {
    ...
    const handlePost = async (data) => {
        ...
        navigator("/")
        await swal("Success", "Update successfully a student", "success")
    }
    return (
        <div>
            ...
            <form onSubmit={handleSubmit(handlePost)}>
                ...
                <div className="row m-3">
                    ...
                    <div className="form-floating mb-3 col-6">
                        <input type="number" className="form-control" {...register("age", {required: true, min: 18})}/>
                        <label>Age</label>
                    </div>
